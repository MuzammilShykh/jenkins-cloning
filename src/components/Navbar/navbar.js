import './navbar.css';
import  img7 from '../../1/icon.svg'
export function Navbar() {
    return(
      <nav className="navbar navbar-expand-lg navbar-light  sticky-top mynavbar" >
      ...
      <ul className="navbar-nav name" >
        <li>
          <a className="navbar-brand brand font " href="#"  ><b> Jenkins </b></a>
        </li>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item dropdown">
            ...
            <img src={img7} alt="" height = ""/>  {/* <img src={logo} className="App-logo" alt="logo" /> */}
            </a>
         ...
         {/* blog */}
          ...
          <li className="nav-item ">
            <a className="nav-link link-color blog" href="#" >Blog</a>
          </li>

        {/* dropdown Documenttation */}

          <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle link-color documentation" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Documentation
        </a>
        ...
        {/* plugins */}
          ...
          <li className="nav-item">
            <a className="nav-link link-color plugin" href="#">Plugins</a>
          </li>

        {/* dropdown comunity */}

          <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle link-color community" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Community
        </a>
            <div className="dropdown-menu" aria-labelledby="navbarDropdown" >
...
{/* dropdown subprojects */}
          ...
          <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle link-color subproject" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Subprojects
        </a>
            <div className="dropdown-menu" aria-labelledby="navbarDropdown" >
              <a className="dropdown-item" href="#">Overview</a>
         ...
         {/* dropdown About */}
          ...
          <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle link-color about" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              About
        </a>
            <div className="dropdown-menu" aria-labelledby="navbarDropdown" >
              <a className="dropdown-item" href="#">Roadmap</a>
        ...
        {/* Dropdown English */}
          ...
          <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle link-color english" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              English
        </a>
            <div className="dropdown-menu" aria-labelledby="navbarDropdown" >
      ...
      <button type="button" class="btn download_button">Download</button>
